    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult About()
        {
            ViewBag.Message = "Веб апликација со наслов Escape, каде е овозможено креирање на профили и " +
                "поставување на дела креирани со сопствен труд(art). Апликацијата не е наменета за дружење и" +
                ...
                " преглед на сите ставки(или одредена ставка), можности за доделување на улоги на " +
